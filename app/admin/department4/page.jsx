  ...
  const deptRows = [
    {
      ...
      engineer: "Amit Kumar",
      task: "Water Leakage & Pipe Bursts",
      contact: "*******454",
      select: "",
    },
    {
      date: "06 Sept 2025, 08:20 PM",
      engineer: "Irregular Water Supply",
      task: "Poor Grievance Redressal",
      contact: "*******324",
      select: "",
    },
    {
      ...
      <main className="flex-1 py-8 px-8 text-black">
        ...
        <div className="flex items-center justify-between mb-7">
          <div className="flex items-center gap-3">
            <span className="font-bold text-2xl">Water Supply Dept</span>
          </div>
