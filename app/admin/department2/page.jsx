  ...
  const deptRows = [
    {
      ...
      engineer: "Amit Kumar",
      task: "Road FLooding Poor Drainage",
      contact: "*******454",
      select: "",
    },
    {
    ...
    },
    {
      ...
      task: "Broken or Missing Streetlights",
      contact: "*******123",
      select: "",
    },
    {
      ...
      <main className="flex-1 py-8 px-8 text-black">
        ...
        <div className="flex items-center justify-between mb-7">
          <div className="flex items-center gap-3">
            <span className="font-bold text-2xl">Public Works Dept.</span>
          </div>
